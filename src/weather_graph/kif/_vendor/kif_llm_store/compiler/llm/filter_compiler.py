...
# PATCH 1 (weather-graph vendor): upstream has an *absolute* `from llm_store.constants import ...`
# here, which only resolves if the package is installed under the directory name `llm_store` --
# contradicting its own documented import name (`kif_llm_store`). Made relative so it resolves
# regardless of what the package is called. See analysis/kif_llm_analysis.md blocker #2.
